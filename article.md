...
php初心者の私がphpを勉強するにあたって、自分で行った勉強の内容を備忘録として作成していきたいと思います。

初学者向けのphp勉強でToDoリストを作成するのが有名ですが、つまづいたところをググるとすぐに答えが出てきてしまうので、比較的記事や情報が少ないログインページを作成していきたいと思います。
...
すなわち、完全に手探りな状態で開発することになってしまいます。
...
これらの課題を解決していきながらphpに対する知識をよりインプット/アウトプットしていきたいと思います。